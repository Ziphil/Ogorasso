...
const INFLECTION_CODING_MAP = new Map<string, Record<NaturalLocale, string>>([
  ...
  ["prepositional", {japanese: "前置", abbreviation: "PRP"}],
  ["verbophoric", {japanese: "連用", abbreviation: "VPH"}],
  ["substophoric", {japanese: "連体", abbreviation: "SPH"}],
  ["water", {japanese: "水類", abbreviation: "W"}],
  ["fire", {japanese: "火類", abbreviation: "F"}],
